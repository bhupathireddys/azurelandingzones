resource "azurerm_policy_definition" "auto_enable_backup_stg" {
  name         = "auto-enable-backup-stg"
  policy_type  = "Custom"
  mode         = "Indexed"
  display_name = "Auto-Enable Backup for stg VMs"
  description  = "Automatically enable backup for VMs in 'stg' environment tagged with backup=Yes."
