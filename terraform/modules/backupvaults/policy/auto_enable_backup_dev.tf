resource "azurerm_policy_definition" "auto_enable_backup_dev" {
  name         = "auto-enable-backup-dev"
  policy_type  = "Custom"
  mode         = "Indexed"
  display_name = "Auto-Enable Backup for dev VMs"
  description  = "Automatically enable backup for VMs in 'dev' environment tagged with backup=Yes."
