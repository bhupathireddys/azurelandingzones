resource "azurerm_policy_definition" "auto_enable_backup_prd" {
  name         = "auto-enable-backup-prd"
  policy_type  = "Custom"
  mode         = "Indexed"
  display_name = "Auto-Enable Backup for prd VMs"
  description  = "Automatically enable backup for VMs in 'prd' environment tagged with backup=Yes."
